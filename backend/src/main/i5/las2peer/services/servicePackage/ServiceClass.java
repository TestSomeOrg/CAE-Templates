...
@Api
@SwaggerDefinition(info = @Info(title = "$Microservice_Name$", version = "$Microservice_Version$", description = "A las2peer microservice generated by the CAE.", termsOfService = "none", contact = @Contact(name = "$Developer$", email = "CAEAddress@gmail.com"), license = @License(name = "BSD", url = "$License_File_Address$")))
